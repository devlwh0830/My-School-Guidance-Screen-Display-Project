...
def airKorea():
    ...
    target_image = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\test.png') # 대기질 베이스 이미지 불러오기
    ...
    if (float(pm10) <= 30.0):
        add_image1 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\good.png')
        pm10result = str(pm10) + "\n\n좋음"
        draw.text((230,375),f"{pm10result}",fill="black",font=selectedFont,align='center') 
    elif (float(pm10) <= 80.0):
        add_image1 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\middle.png')
        pm10result = str(pm10) + "\n\n보통"
        draw.text((230,375),f"{pm10result}",fill="black",font=selectedFont,align='center') 
    elif (float(pm10) <= 150.0):
        add_image1 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\bad.png')
        pm10result = str(pm10) + "\n\n나쁨"
        draw.text((230,375),f"{pm10result}",fill="black",font=selectedFont,align='center') 
    else:
        add_image1 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\verybad.png')
        pm10result = str(pm10)
        draw.text((230,375),f"{pm10result}",fill="black",font=selectedFont,align='center') 
    ...
    if (float(pm25) <= 15.0):
        add_image2 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\good.png')
        pm25result = str(pm25) + "\n\n좋음"
        draw.text((850,375),f"{pm25result}",fill="black",font=selectedFont,align='center') 
    elif (float(pm25) <= 35.0):
        add_image2 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\middle.png')
        pm25result = str(pm25) + "\n\n보통"
        draw.text((850,375),f"{pm25result}",fill="black",font=selectedFont,align='center') 
    elif (float(pm25) <= 75.0):
        add_image2 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\bad.png')
        pm25result = str(pm25) + "\n\n나쁨"
        draw.text((850,375),f"{pm25result}",fill="black",font=selectedFont,align='center') 
    else:
        add_image2 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\verybad.png')
        pm25result = str(pm25)
        if len(pm25result) >= 3:
    ...
    if (float(o3) <= 0.030):
        add_image3 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\ozon.png')
        o3result = str(o3) + "\n\n좋음"
        draw.text((1425,375),f"{o3result}",fill="black",font=selectedFont,align='center') 
    elif (float(o3) <= 0.090):
        add_image3 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\middle.png')
        o3result = str(o3) + "\n\n보통"
        draw.text((1425,375),f"{o3result}",fill="black",font=selectedFont,align='center') 
    elif (float(o3) <= 0.150):
        add_image3 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\bad.png')
        o3result = str(o3) + "\n\n나쁨"
        draw.text((1425,375),f"{o3result}",fill="black",font=selectedFont,align='center') 
    else:
        add_image3 = Image.open('C:\\Users\\user\\Desktop\\slide show\\images\\baseimages\\verybad.png')
        o3result = str(o3)
        draw.text((1425,375),f"{o3result}",fill="black",font=selectedFont,align='center') 
    ...
    target_image.save("C:\\Users\\user\\Desktop\\slide show\\images\\sky.png")
    target_image.close()
